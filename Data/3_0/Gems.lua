...
return {
	...
	["Metadata/Items/Gems/SkillGemElementalHit"] = {
		...
		tagString = "Attack, Projectile, Melee, Fire, Cold, Lightning, AoE, Bow",
		reqStr = 0,
		reqDex = 100,
		reqInt = 0,
	},
	...
	["Metadata/Items/Gems/SkillGemFrenzy"] = {
		...
		tagString = "Attack, Projectile, Melee, Bow",
		reqStr = 0,
		reqDex = 100,
		reqInt = 0,
	},
	...
	["Metadata/Items/Gems/SkillGemExplosiveArrow"] = {
		...
		tagString = "Fire, Attack, Projectile, AoE, Duration, Bow",
		reqStr = 0,
		reqDex = 100,
		reqInt = 0,
	},
	...
	["Metadata/Items/Gems/SkillGemLightningStrike"] = {
		...
		tagString = "Attack, Projectile, Melee, Lightning",
		reqStr = 0,
		reqDex = 60,
		reqInt = 40,
	},
	["Metadata/Items/Gems/SkillGemVaalLightningStrike"] = {
		...
		tagString = "Vaal, Attack, Melee, Duration, Lightning, Projectile",
		reqStr = 0,
		reqDex = 60,
		reqInt = 40,
	},
	...
	["Metadata/Items/Gems/SkillGemPuncture"] = {
		...
		tagString = "Attack, Projectile, Duration, Melee, Bow",
		reqStr = 0,
		reqDex = 60,
		reqInt = 40,
	},
	...
	["Metadata/Items/Gems/SkillGemFlameTotem"] = {
		...
		tagString = "Totem, Spell, Projectile, Fire",
		reqStr = 60,
		reqDex = 0,
		reqInt = 40,
	},
	...
	["Metadata/Items/Gems/SkillGemStormBurst"] = {
		...
		tagString = "AoE, Spell, Projectile, Lightning, Channelling",
		reqStr = 0,
		reqDex = 0,
		reqInt = 100,
	},
	...
	["Metadata/Items/Gems/SkillGemMoltenStrike"] = {
		...
		tagString = "Attack, Projectile, AoE, Melee, Fire",
		reqStr = 100,
		reqDex = 0,
		reqInt = 0,
	},
	...
	["Metadata/Items/Gems/HeraldOfAgony"] = {
		...
		tagString = "Spell, Herald, Minion, Chaos",
		reqStr = 0,
		reqDex = 100,
		reqInt = 0,
	},
	["Metadata/Items/Gems/HeraldOfPurity"] = {
		...
		tagString = "Spell, Herald, Minion, Duration",
		reqStr = 60,
		reqDex = 0,
		reqInt = 40,
	},
	...
	["Metadata/Items/Gems/SkillGemStaticStrike"] = {
		...
		tagString = "Attack, Melee, AoE, Duration, Lightning, Chaining",
		reqStr = 60,
		reqDex = 0,
		reqInt = 40,
	},
	...
	["Metadata/Items/Gems/SkillGemFrostBlades"] = {
		...
		tagString = "Attack, Projectile, Melee, Cold",
		reqStr = 0,
		reqDex = 100,
		reqInt = 0,
	},
	...
	["Metadata/Items/Gems/SkillGemWildStrike"] = {
		...
		tagString = "Attack, Melee, Lightning, Cold, Fire, Projectile, AoE, Chaining",
		reqStr = 40,
		reqDex = 60,
		reqInt = 0,
	},
	...
	["Metadata/Items/Gems/Smite"] = {
		...
		tagString = "Lightning, Attack, AoE, Duration, Melee, Aura",
		reqStr = 60,
		reqDex = 0,
		reqInt = 40,
	},
	["Metadata/Items/Gems/ScourgeArrow"] = {
		...
		tagString = "Chaos, Attack, Projectile, Channelling, Bow",
		reqStr = 0,
		reqDex = 100,
		reqInt = 0,
	},
	...
	["Metadata/Items/Gems/SupportGemChaosAttacks"] = {
		...
		tagString = "Chaos, Attack, Support, Duration",
		reqStr = 0,
		reqDex = 100,
		reqInt = 0,
	},
